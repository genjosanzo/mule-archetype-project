...
-----------------------------------------------------------------
./src/test/java/${packageInPathFormat}/${artifactId}/${artifactId}.java
...
-----------------------------------------------------------------
./src/test/resources/${artifactId}-functional-test-config.xml
...
Also, MuleSoft, the ${packageInPathFormat}pany behind Mule, offers 24x7 support options:
http://www.mulesoft.${packageInPathFormat}/enterprise-subscriptions-and-support
...
version=${version}
groupId=${packageInPathFormat}
basedir=/Users/alberto/Documents/workspace
--------------------------------------------------------------------